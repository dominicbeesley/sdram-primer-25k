...
create_clock -name CLOCK_BRD_27 -period 37 -waveform {0 18.5} [get_ports {clk_27_i}]

create_generated_clock -name clock_fast -source [get_ports {clk_27_i}] -master_clock CLOCK_BRD_27 -divide_by 9 -multiply_by 32 [get_nets {i_fbsyscon.clk}]
